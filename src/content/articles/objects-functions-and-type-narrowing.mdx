...
But, TypeScript's type narrowing isn't a perfect system.
There are some cases where TypeScript's type system can't narrow values exactly the way you might want.
...
- Function declarations _do_ reset any type narrowing explicitly applied to values
